...
class TestResetQ:
    ...
    def test_OK(self):
        ...
        process = subprocess.Popen(["python", "resetq", "--questionnaire_id", "QQ000","--format", "json"],stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    ...
    def test_no_answers(self):
        process = subprocess.Popen(["python", "resetq", "--questionnaire_id", "QQ876","--format", "json"],stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        output, errors = process.communicate()
        print(errors)
